	...
	*/
	...
	public:
		...
		enum ColorConstant  {
			...
			SEGCOLOR7 =0xB01632, //深蓝色
			SEGCOLOR8 =0xC436D8, //紫色
			SEGCOLOR9 =0x73E7FF //肉色
		};
	...
	case 6:
		*this= Color4<T>(Color4<T>::SEGCOLOR6);
		break;
	case 7:
		*this= Color4<T>(Color4<T>::SEGCOLOR7);
		break;
	case 8:
		*this= Color4<T>(Color4<T>::SEGCOLOR8);
		break;
	case 9:
		*this= Color4<T>(Color4<T>::SEGCOLOR9);
		break;
	default:
