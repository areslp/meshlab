...
**
** Created: Thu Jan 24 16:57:29 2013
...
static const char qt_meta_stringdata_LayerDialog[] = {
    "LayerDialog\0\0event\0keyPressEvent(QKeyEvent*)\0"
    ...
    "adaptLayout(QTreeWidgetItem*)\0removeTag()\0"
};
...
void LayerDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->rasterItemClicked((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->meshItemClicked((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        case 6: _t->adaptLayout((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1]))); break;
        case 7: _t->removeTag(); break;
        default: ;
        }
    }
}
