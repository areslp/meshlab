...
**
** Created: Mon Mar 18 13:12:35 2013
...
public:
    ...
    void setupUi(QDockWidget *DockWidget)
    {
        ...
        shotExport = new QCheckBox(dockWidgetContents);
        shotExport->setObjectName(QString::fromUtf8("shotExport"));
        shotExport->setLayoutDirection(Qt::RightToLeft);
        shotExport->setChecked(true);
        shotExport->setTristate(false);

        _13->addWidget(shotExport);
        ...
        sizePolicy5.setHeightForWidth(plyButton->sizePolicy().hasHeightForWidth());
        plyButton->setSizePolicy(sizePolicy5);
        ...
        sizePolicy6.setHeightForWidth(imageTableWidget->sizePolicy().hasHeightForWidth());
        imageTableWidget->setSizePolicy(sizePolicy6);
        imageTableWidget->setColumnCount(3);
        ...
        saveShotCombo->setCurrentIndex(0);
...
#ifndef QT_NO_TOOLTIP
        shotExport->setToolTip(QApplication::translate("DockWidget", "<html><head><meta name=\"qrichtext\" content=\"1\" /></head><body style=\" white-space: pre-wrap; font-style:normal; text-decoration:none;\"><p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Perform a fast, fixed resolution merging of all the range maps. If unchecked all the rangemaps are simply put in the same space without merging them.</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        shotExport->setText(QApplication::translate("DockWidget", "Export Shots to Raster", 0, QApplication::UnicodeUTF8));
        saveShotCombo->clear();
        saveShotCombo->insertItems(0, QStringList()
         << QApplication::translate("DockWidget", "Export all images", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("DockWidget", "Export only selected images", 0, QApplication::UnicodeUTF8)
        );
#ifndef QT_NO_TOOLTIP
