...
**
** Created: Tue Oct 30 13:11:27 2012
...
static const char qt_meta_stringdata_GeometryAgingPlugin[] = {
    "GeometryAgingPlugin\0"
};
...
const QMetaObjectExtraData GeometryAgingPlugin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GeometryAgingPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GeometryAgingPlugin,
      qt_meta_data_GeometryAgingPlugin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GeometryAgingPlugin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GeometryAgingPlugin))
