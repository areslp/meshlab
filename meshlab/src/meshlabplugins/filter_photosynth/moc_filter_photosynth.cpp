...
**
** Created: Sun Sep 1 18:40:04 2013
...
void FilterPhotosynthPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData FilterPhotosynthPlugin::staticMetaObjectExtraData = {
...
const QMetaObject FilterPhotosynthPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FilterPhotosynthPlugin,
      qt_meta_data_FilterPhotosynthPlugin, &staticMetaObjectExtraData }
};
